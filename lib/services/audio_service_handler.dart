...
class AudioServiceHandler extends BaseAudioHandler
      ...
      playbackState.add(
        PlaybackState(
          ...
          androidCompactActionIndices: const [
            ...
            1,
            2,
          ], // Show rewind, play/pause, fast forward in compact view
  ...
  void setMediaItem({
    ...
    mediaItem.add(
      MediaItem(
        ...
        extras: {'isQuran': true, 'language': 'ar', 'direction': 'rtl'},
      ),
    );
  }
  ...
  Future<void> play() async {
    debugPrint(
      '🔄 AudioServiceHandler.play() called, initialized: $_isInitialized',
    );
    if (_isInitialized) {
      await _player.play();
      ...
      debugPrint(
        '🎵 Audio service play called - media controls should be visible',
      );
    } else {
