// lib/data/quran_data.dart - Centralized Quran Data Source
...
class QuranData {
  ...
  // Helper methods
  static String getSurahName(int surahNumber, {bool english = false}) {
    final names = english ? surahNamesEnglish : surahNames;
  ...
  static bool isValidAyah(int surahNumber, int ayahNumber) {
    ...
    final maxAyah = getAyahCount(surahNumber);
    return ayahNumber >= 1 && ayahNumber <= maxAyah;
  }

  static List<int> getAllSurahNumbers() {
  ...
  static Map<String, dynamic> getSurahInfo(int surahNumber) {
    ...
    return {
      'number': surahNumber,
      'nameArabic': getSurahName(surahNumber),
      'nameEnglish': getSurahName(surahNumber, english: true),
      'ayahCount': getAyahCount(surahNumber),
    };
  }
}